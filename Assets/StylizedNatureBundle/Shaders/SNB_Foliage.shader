	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 appendResult141 = (float4(( ( sin( temp_output_130_0 ) * _WindTrunkAmplitude ) * inputMesh.ase_color.b ) , 0.0 , ( inputMesh.ase_color.b * ( ( _WindTrunkAmplitude * 0.5 ) * cos( temp_output_130_0 ) ) ) , 0.0));
				...
				#endif
				float3 vertexValue = ( appendResult141 + float4( ( simplePerlin2D101 * _WindFoliageAmplitude * inputMesh.normalOS * inputMesh.ase_color.r ) , 0.0 ) ).rgb;
						...
						)
			{
				...
				float2 uv_EmissionRMetallicGSmoothnessB = packedInput.ase_texcoord5.xy * _EmissionRMetallicGSmoothnessB_ST.xy + _EmissionRMetallicGSmoothnessB_ST.zw;
				float4 tex2DNode106 = tex2D( _EmissionRMetallicGSmoothnessB, uv_EmissionRMetallicGSmoothnessB );
				
				surfaceDescription.Albedo = tex2DNode36.rgb;
				surfaceDescription.Normal = unpack104;
				...
				surfaceDescription.Emission = ( tex2DNode106.r * _EmissionStrength * tex2DNode36 ).rgb;
				surfaceDescription.Smoothness = ( tex2DNode106.b * _Specularity );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_EmissionRMetallicGSmoothnessB = packedInput.ase_texcoord.xy * _EmissionRMetallicGSmoothnessB_ST.xy + _EmissionRMetallicGSmoothnessB_ST.zw;
				float4 tex2DNode106 = tex2D( _EmissionRMetallicGSmoothnessB, uv_EmissionRMetallicGSmoothnessB );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_EmissionRMetallicGSmoothnessB = packedInput.ase_texcoord3.xy * _EmissionRMetallicGSmoothnessB_ST.xy + _EmissionRMetallicGSmoothnessB_ST.zw;
				float4 tex2DNode106 = tex2D( _EmissionRMetallicGSmoothnessB, uv_EmissionRMetallicGSmoothnessB );
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_EmissionRMetallicGSmoothnessB = packedInput.ase_texcoord7.xy * _EmissionRMetallicGSmoothnessB_ST.xy + _EmissionRMetallicGSmoothnessB_ST.zw;
				float4 tex2DNode106 = tex2D( _EmissionRMetallicGSmoothnessB, uv_EmissionRMetallicGSmoothnessB );
...
/*ASEBEGIN
Version=18912
-1919;37;1906;945;1618.029;828.4614;1.787164;True;True
Node;AmplifyShaderEditor.CommentaryNode;144;-2566.226,-78.21088;Inherit;False;1821.23;666.407;Vertex offset using Blue Vertex Color channel;14;140;141;137;135;134;136;138;139;133;130;143;131;129;148;Wind Trunk;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;131;-2577.56,207.0788;Float;False;Property;_WindTrunkSpeed;Wind Trunk Speed;10;0;Create;True;0;0;0;False;0;False;0;0.3;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;148;-2290.363,187.4087;Inherit;False;2;2;0;FLOAT;2;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;129;-2475.974,-5.150267;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;102;-2561.934,676.2968;Inherit;False;1715.196;801.9376;Vertex offset using Red Vertex Color channel base on panning noise;11;97;149;85;99;132;101;98;93;95;94;96;Wind Foliage;1,1,1,1;0;0
Node;AmplifyShaderEditor.WorldPosInputsNode;85;-2513.734,831.5087;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;96;-2449.188,1246.13;Float;False;Property;_WindFoliageSpeed;Wind Foliage Speed;8;0;Create;True;0;0;0;False;0;False;0;0.3;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;143;-2012.619,186.2907;Float;False;Property;_WindTrunkAmplitude;Wind Trunk Amplitude;9;0;Create;True;0;0;0;False;0;False;0;0.06;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;94;-2481.399,1076.711;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;130;-2135.33,63.05664;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;149;-2229.214,844.5707;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;139;-1746.317,231.4307;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;133;-1846.131,57.03967;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;95;-2142.558,1105.345;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CosOpNode;140;-1962.878,411.1227;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;93;-1877.741,856.0187;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;2,2;False;1;FLOAT;0.1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.VertexColorNode;136;-1501.291,153.8858;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;138;-1599.118,400.2377;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;134;-1665.63,28.5387;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;98;-1483.137,1048.411;Float;False;Property;_WindFoliageAmplitude;Wind Foliage Amplitude;7;0;Create;True;0;0;0;False;0;False;0;0.05;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;132;-1474.849,1304.581;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;137;-1271.255,387.8776;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalVertexDataNode;97;-1484.071,1141.227;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NoiseGeneratorNode;101;-1457.095,792.1337;Inherit;True;Simplex2D;False;False;2;0;FLOAT2;1,1;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;135;-1224.172,42.78369;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;141;-924.6312,297.7057;Inherit;False;COLOR;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;36;-1824.937,-545.4274;Inherit;True;Property;_MainTex;MainTex;1;0;Create;True;0;0;0;False;0;False;-1;None;fcbd578e80a32e8469fe6fecd607d8aa;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;105;-2044.889,-869.4987;Float;False;Property;_NormalStrength;Normal Strength;5;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;106;-1834.936,-750.888;Inherit;True;Property;_EmissionRMetallicGSmoothnessB;Emission (R), Metallic (G), Smoothness (B);2;0;Create;True;0;0;0;False;0;False;-1;None;b40e4f8e896e21344a3d5ca84d541ca5;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;99;-1002.618,1025.053;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;163;-1456.925,-489.9608;Float;False;Property;_Specularity;Specularity;3;0;Create;True;0;0;0;False;0;False;1.5;1;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;104;-1830.615,-929.0303;Inherit;True;Property;_NormalMap;Normal Map;4;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;fc84c738c0737df418cb63cacdcb9f84;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;142;61.21584,318.7608;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;176;3.914215,-142.4963;Inherit;False;Property;_AlphaClip;Alpha Clip;0;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
WireConnection;165;6;108;0
WireConnection;165;7;164;0
WireConnection;165;9;36;4
WireConnection;165;10;176;0
WireConnection;165;11;142;0
ASEEND*/
//CHKSM=76D846DD6909BB6BD66B72D391CFDA3010EDF846