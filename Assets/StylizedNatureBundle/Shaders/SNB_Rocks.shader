	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_DiffuseSmoothnessA = packedInput.ase_texcoord5.xy * _DiffuseSmoothnessA_ST.xy + _DiffuseSmoothnessA_ST.zw;
				...
				surfaceDescription.Emission = ( lerpResult47 * _EmissionStrength ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 clampResult38 = clamp( _RocksColorVariation , float4( 0,0,0,0 ) , float4( 0.245283,0.245283,0.245283,0 ) );
				float clampResult16 = clamp( ( _RocksBrightness * 2.0 ) , 0.2 , 5.0 );
				float2 uv_DiffuseSmoothnessA = packedInput.ase_texcoord.xy * _DiffuseSmoothnessA_ST.xy + _DiffuseSmoothnessA_ST.zw;
				float4 tex2DNode2 = tex2D( _DiffuseSmoothnessA, uv_DiffuseSmoothnessA );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_DiffuseSmoothnessA = packedInput.ase_texcoord3.xy * _DiffuseSmoothnessA_ST.xy + _DiffuseSmoothnessA_ST.zw;
				float4 tex2DNode2 = tex2D( _DiffuseSmoothnessA, uv_DiffuseSmoothnessA );
		...
		Pass
		{
						...
						)
			{
				...
				float4 clampResult38 = clamp( _RocksColorVariation , float4( 0,0,0,0 ) , float4( 0.245283,0.245283,0.245283,0 ) );
				float clampResult16 = clamp( ( _RocksBrightness * 2.0 ) , 0.2 , 5.0 );
				float2 uv_DiffuseSmoothnessA = packedInput.ase_texcoord7.xy * _DiffuseSmoothnessA_ST.xy + _DiffuseSmoothnessA_ST.zw;
				float4 tex2DNode2 = tex2D( _DiffuseSmoothnessA, uv_DiffuseSmoothnessA );
...
/*ASEBEGIN
Version=18912
-1919;37;1906;945;2030.831;687.6826;1.737783;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-1633.36,-630.8596;Float;False;Property;_RocksBrightness;Rocks Brightness;4;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;85;-1237.245,244.574;Float;False;Property;_GrassLevel;Grass Level;7;0;Create;True;0;0;0;False;0;False;5;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;18;-1136.524,-839.4659;Float;False;Property;_RocksColorVariation;Rocks Color Variation;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.3649149,0.3962263,0.2971697,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;51;-1241.086,340.4883;Float;False;Property;_GrassAmount;Grass Amount;6;0;Create;True;0;0;0;False;0;False;0;4;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;55;-783.0206,-112.8873;Float;False;Property;_GrassColor;Grass Color;8;0;Create;True;0;0;0;False;0;False;0.7009608,1,0.06132078,0;0.5126749,0.764151,0.2342915,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;88;1;1;0
WireConnection;88;6;87;0
WireConnection;88;7;2;4
ASEEND*/
//CHKSM=38A107727A2B031965F7612D6DE429D2DE9B1891