	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 appendResult58 = (float4(( ( sin( temp_output_48_0 ) * _WindTrunkAmplitude ) * inputMesh.ase_color.b ) , 0.0 , ( inputMesh.ase_color.b * ( ( _WindTrunkAmplitude * 0.5 ) * cos( temp_output_48_0 ) ) ) , 0.0));
						...
						)
			{
				...
				float2 uv_DiffuseSmoothnessA = packedInput.ase_texcoord6.xy * _DiffuseSmoothnessA_ST.xy + _DiffuseSmoothnessA_ST.zw;
				...
				surfaceDescription.Albedo = ( ( _HeightBrightness * ( saturate( ( ( packedInput.ase_texcoord5.xyz.y - _HeightStartGradient ) / _HeightGradient ) ) * temp_output_19_0 ) ) + temp_output_19_0 ).rgb;
				...
				surfaceDescription.Emission = ( _EmissionStrength * tex2DNode2 ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 clampResult38 = clamp( _TrunkColorVariation , float4( 0,0,0,0 ) , float4( 0.3867925,0.3867925,0.3867925,0 ) );
				float clampResult16 = clamp( ( _TrunkBrightness * 2.0 ) , 0.5 , 5.0 );
				float2 uv_DiffuseSmoothnessA = packedInput.ase_texcoord1.xy * _DiffuseSmoothnessA_ST.xy + _DiffuseSmoothnessA_ST.zw;
				float4 tex2DNode2 = tex2D( _DiffuseSmoothnessA, uv_DiffuseSmoothnessA );
				float4 temp_output_19_0 = ( clampResult38 + ( clampResult16 * tex2DNode2 ) );
				...
				surfaceDescription.Albedo = ( ( _HeightBrightness * ( saturate( ( ( packedInput.ase_texcoord.xyz.y - _HeightStartGradient ) / _HeightGradient ) ) * temp_output_19_0 ) ) + temp_output_19_0 ).rgb;
				surfaceDescription.Normal = unpack1;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;
		...
		Pass
		{
						...
						)
			{
				...
				float4 clampResult38 = clamp( _TrunkColorVariation , float4( 0,0,0,0 ) , float4( 0.3867925,0.3867925,0.3867925,0 ) );
				float clampResult16 = clamp( ( _TrunkBrightness * 2.0 ) , 0.5 , 5.0 );
				float2 uv_DiffuseSmoothnessA = packedInput.ase_texcoord8.xy * _DiffuseSmoothnessA_ST.xy + _DiffuseSmoothnessA_ST.zw;
				float4 tex2DNode2 = tex2D( _DiffuseSmoothnessA, uv_DiffuseSmoothnessA );
				float4 temp_output_19_0 = ( clampResult38 + ( clampResult16 * tex2DNode2 ) );
				...
				surfaceDescription.Albedo = ( ( _HeightBrightness * ( saturate( ( ( packedInput.ase_texcoord7.xyz.y - _HeightStartGradient ) / _HeightGradient ) ) * temp_output_19_0 ) ) + temp_output_19_0 ).rgb;
				surfaceDescription.Normal = unpack1;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;
...
/*ASEBEGIN
Version=18912
-1919;37;1906;945;1772;426.3867;1.307158;True;True
...
WireConnection;61;7;2;4
WireConnection;61;11;58;0
ASEEND*/
//CHKSM=BF66A82B2667667855B54B6857E475D8E3841D14